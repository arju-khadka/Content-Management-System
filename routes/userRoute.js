const { renderAddUser, addUSer, renderLoginForm, loginUser, logOutUser, forgotPassword, handleForgotPassword, renderOtpForm, verifyOtp, renderResetPassword } = require("../controller/user/userController")
